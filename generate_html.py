...
<body class="min-h-screen flex flex-col antialiased selection:bg-brand-red selection:text-white">
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex-1 w-full">
    ...
    <section id="tab-vision-mercado" class="space-y-6">
      ...
      <div class="glass-card p-5 rounded-xl w-full relative z-30 overflow-visible">
    ...
    <section id="tab-ficha-compania" class="hidden space-y-6">
      ...
      <div class="glass-card p-5 rounded-xl border-l-4 border-l-brand-red flex flex-wrap items-center justify-between gap-4 relative z-30 overflow-visible">
        <div>
          <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-3">
          <div class="relative w-64 sm:w-80" id="ciaComboboxContainer">
            ...
            <div id="ciaComboboxDropdown" class="hidden absolute top-full left-0 right-0 mt-1 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl z-[100] p-2 text-xs backdrop-blur-md max-h-72 flex flex-col">
              <div class="relative mb-2">
                <i class="fa-solid fa-magnifying-glass absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></i>
    ...
    <section id="tab-inversiones-finanzas" class="hidden space-y-6">
      ...
      <div class="glass-card p-5 rounded-xl border-l-4 border-l-amber-500 flex flex-wrap items-center justify-between gap-4 relative z-30 overflow-visible">
        <div>
          <div class="flex items-center gap-3">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <div class="flex items-center gap-2">
            ...
            <div class="relative w-64 sm:w-72" id="invComboboxContainer">
              ...
              <div id="invComboboxDropdown" class="hidden absolute top-full left-0 right-0 mt-1 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl z-[100] p-2 text-xs backdrop-blur-md max-h-72 flex flex-col">
                <div class="relative mb-2">
                  <i class="fa-solid fa-magnifying-glass absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></i>
    ...
    <section id="tab-solvencia-ratios" class="hidden space-y-6">
      ...
      <div class="glass-card p-5 rounded-xl border-l-4 border-l-emerald-500 flex flex-wrap items-center justify-between gap-4 relative z-30 overflow-visible">
        <div>
          <div class="flex items-center gap-3">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <div class="flex items-center gap-2">
            ...
            <div class="relative w-64 sm:w-72" id="solvComboboxContainer">
              ...
              <div id="solvComboboxDropdown" class="hidden absolute top-full left-0 right-0 mt-1 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl z-[100] p-2 text-xs backdrop-blur-md max-h-72 flex flex-col">
                <div class="relative mb-2">
                  <i class="fa-solid fa-magnifying-glass absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></i>
    ...
    <section id="tab-ratios-gestion" class="hidden space-y-6">
      ...
      <div class="glass-card p-5 rounded-xl border-l-4 border-l-indigo-500 flex flex-wrap items-center justify-between gap-4 relative z-30 overflow-visible">
        <div>
          <div class="flex items-center gap-3">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <div class="flex items-center gap-2">
            ...
            <div class="relative w-64 sm:w-72" id="gestComboboxContainer">
              ...
              <div id="gestComboboxDropdown" class="hidden absolute top-full left-0 right-0 mt-1 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl z-[100] p-2 text-xs backdrop-blur-md max-h-72 flex flex-col">
                <div class="relative mb-2">
                  <i class="fa-solid fa-magnifying-glass absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></i>
